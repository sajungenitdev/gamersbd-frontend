...
const PromotionalSectionMinimal = () => {
  return (
    <section className="py-12 bg-[#1a1a1a] dark:bg-white transition-colors duration-300">
      <div className="container mx-auto ">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Fortnite */}
          <div className="bg-[#2A2A2A] dark:bg-white rounded-2xl p-8 border border-[#2A2A2A] dark:border-white">
            ...
            <h3 className="text-xl font-semibold pt-3 text-white dark:text-black mb-2">
              AmongUs x Fortnite
            </h3>
...
export default PromotionalSectionMinimal;
